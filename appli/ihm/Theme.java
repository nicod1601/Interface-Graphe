...
public class Theme
{
	...
	public static void applyGlobalLookAndFeel()
	{
		...
		// ── Menus ─────────────────────────────────────────────────────────────
		// On force des couleurs opaques pour les menus — Metal ignore les alphas
		UIManager.put("Menu.background",              PANEL);
		UIManager.put("Menu.foreground",              TEXT);          // texte clair lisible
		UIManager.put("Menu.font",                    FONT_NORMAL);
		UIManager.put("Menu.selectionBackground",     PANEL_ALT);
		...
		UIManager.put("MenuItem.foreground",          TEXT);          // texte clair lisible
		UIManager.put("MenuItem.font",                FONT_NORMAL);
		UIManager.put("MenuItem.selectionBackground", PANEL_ALT);
		...
		UIManager.put("ScrollBar.thumb",              new Color(52, 66, 95));
		UIManager.put("ScrollBar.thumbDarkShadow",    BACKGROUND);
		UIManager.put("ScrollBar.thumbShadow",        BACKGROUND);
		UIManager.put("ScrollBar.thumbHighlight",     new Color(70, 88, 120));
		...
		UIManager.put("ToolTip.foreground",           ACCENT);
